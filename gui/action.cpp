...
#define ADD_ACTION_EX(name, func) mf[name] = &GUIAction::func
		...
		// TWRP app install/uninstall removed (ArtisanRP does not bundle a companion app)
...
// TWRP app check/install/uninstall functions removed (ArtisanRP does not bundle a companion app)
